...
class MyActiveJobs extends Component {
    ...
    deljob(id) {
        ...
        this.props.history.push('/viewMyActiveJobs');
        this.props.history.push('/appJobDetails');
    ...
    editJob(job) {
        ...
        this.setState({instagram:job.instagram})
        this.setState({youtube:job.youtube})
        this.setState({website:job.website})
                            ...
                            <Table>
                                <TableHead>
                                    <TableRow>
                                            ...
                                            <TableCell>Job's Details</TableCell>
                                ...
                                <TableBody>
                                    {this.state.jobs.filter(item => item.recruiter === userid && item.numpos < item.posmax).map((job,ind) => (
                                        <TableRow key={ind}>
                                            ...
                                            <TableCell>{job.instagram}</TableCell>
                                            <TableCell>{job.youtube}</TableCell>
                                            <TableCell>{job.website}</TableCell>
                                            <TableCell><Link
                                                    to={{
                                                        pathname: "/addJobDetails",
                                                        state: job._id // data array of objects
                                                    }}
                                                    >View Deatils</Link></TableCell>
                                            <TableCell><Link
                                                    to={{
                                                        pathname: "/appList",
                                                        state: job._id // data array of objects
                                                    }}
                                                    >View applications</Link></TableCell>
                                            ...
                                            : 
                                                <div>
                                                    ...
                                                    <form noValidate onSubmit={this.onSubmit}>
                                                        ...
                                                        <div className="input-field col s12">
                                                            <label htmlFor="youtube">YouTube</label><br></br>
                                                            <input
                                                                onChange={this.onChange}
